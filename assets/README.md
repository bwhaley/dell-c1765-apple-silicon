# Dell printer artwork

`DellC1765.icns` is the original printer icon from Dell's macOS C1765 driver:
`/Library/Printers/Dell/Icons/Dell C1765 Color Printer.icns`.
`dell-c1765.png` is a PNG conversion of that icon.
...
The legacy Dell driver is not needed for installation or printing.
